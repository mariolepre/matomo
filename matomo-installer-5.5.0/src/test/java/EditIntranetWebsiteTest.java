    ...
    public void testEditIntranetWebsite() {
        ...
        for (WebElement row : rows) {
            ...
            if (rowText.equals("Intranet Web Test")) {
                ...
                driver.findElement(By.cssSelector("#content > div:nth-child(2) > div > div.sitesManagerList > div:nth-child(4) > div > div.card-content > div > div:nth-child(3) > div:nth-child(12) > div > div > div.col.s12.input-field.m6 > div > div")).click();
                driver.findElement(By.xpath("//span[contains(text(), 'Ecommerce enabled')]")).click();
                driver.findElement(By.cssSelector("#content > div:nth-child(2) > div > div.sitesManagerList > div:nth-child(4) > div > div.card-content > div > div:nth-child(6) > div.col.s12.input-field.m6 > div > div")).click();
