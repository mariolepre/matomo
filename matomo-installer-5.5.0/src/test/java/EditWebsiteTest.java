    ...
    public void testEditWebsite() {
        ...
        for (WebElement row : rows) {
            ...
            if (rowText.equals("Web Test")) {
                ...
                driver.findElement(By.id("excluded_referrers")).sendKeys("https://webtest.matomo.it/info");
                driver.findElement(By.cssSelector("#content > div:nth-child(2) > div > div.sitesManagerList > div:nth-child(2) > div > div.card-content > div > div:nth-child(3) > div:nth-child(12) > div > div > div.col.s12.input-field.m6 > div > div")).click();
                driver.findElement(By.xpath("//span[contains(text(), 'Ecommerce enabled')]")).click();
                driver.findElement(By.xpath("/html/body/div[1]/div[4]/div[2]/div[2]/div[2]/div/div[5]/div[2]/div/div[1]/div/div[6]/div[1]/div/div/input")).click();
