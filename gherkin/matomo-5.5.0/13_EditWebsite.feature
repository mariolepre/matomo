Scenario: Edit website URL's, exlude parameters and change Ecommerce, Time Zone
  ...
  And check the "Web Test" website is present
  And click the "Web Test" website modify icon
  And clean the "URLs" field
  And enters "https://webtest.matomo.it" on the "URL's" field
  ...
  And enters "https://webtest.matomo.it/info" on "Excluded refferers" field
