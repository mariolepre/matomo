Scenario: Add a new website to track
  ...
  And clicks on the trash button on the row of the website "Intranet Web Test"
  And enters "e2eW3Bt3s71nGB3nchM4rK" in the "Password" field
  And clicks on "confirm" button
  Then the "Intranet Web Test" website is no more displayed on the list of website