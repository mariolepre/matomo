...
public class LogoutUserTest {
    ...
    public void testAdminLoginWithValidCredentials() {
        ...
        driver.findElement(By.id("topmenu-login")).click();
        WebElement loginCard = driver.findElement(By.className("card-title"));
        assertEquals("Sign in", loginCard.getText().trim());
    }
