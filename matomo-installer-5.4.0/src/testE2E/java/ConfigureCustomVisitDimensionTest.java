...
public class ConfigureCustomVisitDimensionTest {
    ...
    public void testConfigureCustomVisitDimension() {
        ...
        driver.findElement(By.cssSelector("#content > div:nth-child(2) > div > div > div:nth-child(1) > div > div:nth-child(2) > div > div > div > div > button")).click();
