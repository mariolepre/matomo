...
public class AddNewIntranetWebsiteTest {
    ...
    @Test
    @DisplayName("Add Intranet Website")
    public void testAddIntranetWebsite() {
        ...
        driver.findElement(By.xpath("//span[contains(text(),'Intranet Website')]")).click();
        driver.findElement(By.cssSelector("input[placeholder='Name']")).sendKeys("Intranet Web Test");
        driver.findElement(By.id("urls")).sendKeys("http://intranetwebtest.matomo.it");
